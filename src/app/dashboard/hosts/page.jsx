...
export default function HostsPage() {
  ...
  const handleConfirmDelete = async () => {
    if (deleteHostId) {
      try {
        await fetch(`https://server-me.vercel.app/api/v1/guests/delete/${deleteHostId}`, { method: "DELETE" })
  ...
  const paginatedHosts = filteredHosts.slice((currentPage - 1) * rowsPerPage, currentPage * rowsPerPage)
  ...
  return (
    <div className="flex-1 space-y-4 bg-gray-200 p-8 pt-6">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-semibold tracking-tight font-bricolage">Hosts</h2>
        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="grid  gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card className="">
              ...
              <CardContent>
                <div className="text-3xl font-bricolage font-bold">{guests?.length > 0 ? 28  : 0}</div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Active Host Bookings</CardTitle>
                <ArrowUpRight className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">0</div>
          ...
          <Card className="col-span-4">
            <CardHeader>
              <CardTitle className="text-absoluteDark font-bricolage font-medium text-xl">Host List</CardTitle>
                ...
                <>
                          ...
                          <TableCell>
                            <span
                              className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${
                                guest.status.active === true ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                              }`}
                            >
                              {guest.status.active === true ? "Active" : "Inactive"}
                            </span>
                          </TableCell>
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    <small>
                      ...
                      {Math.min(currentPage * rowsPerPage, filteredHosts.length)} of {filteredHosts.length} entries
                    </small>
